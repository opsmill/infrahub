...
PROJECT_ENV_VARIABLES: dict[str, str] = {
    ...
    "INFRAHUB_TESTING_TELEMETRY_CRON": "",
    "INFRAHUB_TESTING_TELEMETRY_OPTOUT": "true",
    # Healthcheck configuration
    "HEALTHCHECK_MESSAGE_QUEUE_INTERVAL": "5s",
    "HEALTHCHECK_MESSAGE_QUEUE_TIMEOUT": "30s",
    "HEALTHCHECK_MESSAGE_QUEUE_RETRIES": "10",
    "HEALTHCHECK_MESSAGE_QUEUE_START_PERIOD": "3s",
    "HEALTHCHECK_CACHE_INTERVAL": "5s",
    "HEALTHCHECK_CACHE_TIMEOUT": "5s",
    "HEALTHCHECK_CACHE_RETRIES": "3",
    "HEALTHCHECK_DATABASE_INTERVAL": "2s",
    "HEALTHCHECK_DATABASE_TIMEOUT": "10s",
    "HEALTHCHECK_DATABASE_RETRIES": "20",
    "HEALTHCHECK_DATABASE_START_PERIOD": "3s",
    "HEALTHCHECK_TASK_MANAGER_DB_INTERVAL": "10s",
    "HEALTHCHECK_TASK_MANAGER_DB_TIMEOUT": "5s",
    "HEALTHCHECK_TASK_MANAGER_DB_RETRIES": "5",
    "HEALTHCHECK_TASK_MANAGER_INTERVAL": "5s",
    "HEALTHCHECK_TASK_MANAGER_TIMEOUT": "5s",
    "HEALTHCHECK_TASK_MANAGER_RETRIES": "20",
    "HEALTHCHECK_TASK_MANAGER_START_PERIOD": "10s",
    "HEALTHCHECK_SERVER_INTERVAL": "5s",
    "HEALTHCHECK_SERVER_TIMEOUT": "5s",
    "HEALTHCHECK_SERVER_RETRIES": "20",
    "HEALTHCHECK_SERVER_START_PERIOD": "10s",
    "HEALTHCHECK_SERVER_LB_INTERVAL": "5s",
    "HEALTHCHECK_SERVER_LB_TIMEOUT": "5s",
    "HEALTHCHECK_SERVER_LB_RETRIES": "20",
    "HEALTHCHECK_SERVER_LB_START_PERIOD": "10s",
    "HEALTHCHECK_SCRAPER_INTERVAL": "5s",
    "HEALTHCHECK_SCRAPER_TIMEOUT": "5s",
    "HEALTHCHECK_SCRAPER_RETRIES": "10",
    "HEALTHCHECK_SCRAPER_START_PERIOD": "10s",
}
