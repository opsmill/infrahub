    ...
    def model_loader(self, model_name: str, model: DiffSyncModel):
        for element in self.config.schema_mapping:
            ...
            try:
                ...
                objs = response_data.get(resource_name, {})  # Extract the resource_name dictionary
...
class ObserviumModel(DiffSyncModelMixin, DiffSyncModel):
    ...
    def filter_records(cls, records: list[Any]) -> list[Any]:
        ...
        specific filtering logic based on filter expressions defined in the configuration.
        """
        return records
