...
from infrahub_sync.jinja_filters import (
    filter_get_identifier,
    filter_get_attributes,
    filter_list_to_set,
    filter_list_to_str,
    filter_has_node,
    filter_has_field,
...
# NETBOX_TOKEN = "110ed3a44c36ea5edf2ed30bb941fe0187f466bf"
...
def diff(
    ...
    ptd = Potenda(destination=dst, source=src, config=sync_instance, top_level=TOP_LEVEL)
    ptd.load()
...
def generate(
    ...
    template_dir_absolute = str(os.path.join(here, "templates"))
