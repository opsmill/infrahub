...
on:
  ...
  bots:
    - "dependabot[bot]"
# Dependabot-triggered runs get a read-only GITHUB_TOKEN and only Dependabot
# secrets; every write happens in a separate workflow's trusted workflow_run context.
