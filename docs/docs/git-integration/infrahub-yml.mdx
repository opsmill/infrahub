...
Many definitions in `.infrahub.yml` use [groups](../groups/) to specify their targets:
...
See [organizing objects with groups](../groups/) for details on creating target groups.
...
- [Understanding Git repositories in Infrahub](./index.mdx) - Repository integration concepts
- [Understanding groups](../groups/) - Organizational concepts for targeting operations
- [How to organize objects with groups](../groups/) - Creating and managing groups
- [Schema development](../schema/) - Designing infrastructure data models
- [Transformations](../transformations/) - Data processing and template concepts
- [Generators](../generators/) - Infrastructure provisioning automation
- [Artifacts](../artifacts/) - Output generation and delivery
