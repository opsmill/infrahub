...
<ReferenceLink title="Enabling explicit merge commits" url="./connect-repository#customizing-git-merge-behavior"/>
...
- [Proposed Changes](../proposed-changes/index.mdx) - Understanding the merge and review process
- [Version control in Infrahub](../immutable-history/index.mdx) - Broader context of Infrahub's version control features
