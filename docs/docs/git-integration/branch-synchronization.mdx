...
- [Understanding Git repositories in Infrahub](./) - Repository integration concepts and architecture
- [How to connect external Git repositories](connect-repository) - Step-by-step repository setup guide
- [Understanding branching in Infrahub](../branches/index.mdx) - Branch isolation, hierarchy, and workflows
