...
A configuration change requires a restart of the Infrahub server. For detailed instructions on applying configuration changes to your deployment, see [How to configure Infrahub](../guides/configuration-changes.mdx).
...
To verify that the selective synchronization rules are working correctly, you need a Git repository connected to Infrahub. If you haven't connected a repository yet, see [How to connect external Git repositories](../guides/repository.mdx).
