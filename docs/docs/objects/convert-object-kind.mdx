...
- **[Version control](../immutable-history/)**: How conversions interact with branch and merge operations
- **[Metadata](./metadata)**: How object metadata is preserved during conversion
- **[GraphQL](../development-resources/graphql/)**: The API mechanisms that enable conversion operations
