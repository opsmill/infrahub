...
> Assumes a working Infrahub instance, a connected Git repository, and `infrahubctl` configured locally. See [Installation](../deploy-manage/install-configure/install/) and [Connect a repository](../git-integration/connect-repository) if you're starting fresh.
