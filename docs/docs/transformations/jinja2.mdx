...
For a step-by-step walkthrough with a running example, see [Build a Jinja2 Transformation](../learn/tutorials/transformations/build-a-jinja2-transformation) in the Academy tutorials.
