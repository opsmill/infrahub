...
For a step-by-step walkthrough with a running example, see [Build a Python Transformation](../learn/tutorials/transformations/build-a-python-transformation) in the Academy tutorials.
