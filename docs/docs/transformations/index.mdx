...
- As part of an [artifact](../artifacts/)
...
Transformations themselves are generic pieces of logic that process data and produce output. They become targeted to specific objects through [artifact definitions](../artifacts/) and [Generators](../generators/), which combine a Transformation with a [group](../groups/) of targets.
