...
release_type: patch
description: "Ensure that only users with 'manage schema' permissions can add or remove dropdown and enum values (6410) Fix bug in branch delete cypher query that could leave behind orphaned branch-agnostic relationships."
---
