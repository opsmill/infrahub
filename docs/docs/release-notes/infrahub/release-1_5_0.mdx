...
Version 1.5.0b2 of Infrahub requires the usage of infrahub-sdk version v1.15.0b0, which has been published to [PyPi](https://pypi.org/project/infrahub-sdk/1.15.0b0/).
