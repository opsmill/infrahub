...
release_type: minor
description: "General availability: improved diffing, rebasing, and branch merges for a production-ready source of truth."
---
...
- [SSO Guide](../../deploy-manage/user-management/sso/overview)
...
- [Account Permissions Guide](../../deploy-manage/user-management/permissions-roles/overview)
- [Permissions Roles Topic](../../deploy-manage/user-management/permissions-roles/overview)
