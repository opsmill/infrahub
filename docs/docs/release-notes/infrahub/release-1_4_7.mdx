...
release_type: patch
description: "Added optional configuration to fetch and map groups when using Google as an identity provider for OAuth/OIDC. Added the name of the artifact definition to the payload of artifact webhook events."
---
