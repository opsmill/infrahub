...
release_type: patch
description: "Data diffs are loaded in sequential batches for faster performance with large changes. The diff tree and diff list can now be scrolled independently."
---
<table>
  <tbody>
    <tr>
