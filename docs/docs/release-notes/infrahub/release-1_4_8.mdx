...
release_type: patch
description: "Report proper branch when read-only repositories fail to synchronize due to invalid branch (5713) Add an HFID for Attribute and Relationship matches for a Node Trigger Rule (6713)"
---
