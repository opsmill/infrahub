...
release_type: patch
description: "Add usage of Towncrier to generate Changelog as part of the release process. Serve Swagger & Redoc files locally so that the REST-API docs work offline or when isolated from the internet."
---
<table>
  <tbody>
    <tr>
