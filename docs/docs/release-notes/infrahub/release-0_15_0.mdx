---
title: Release 0.15
description: "Profile enhancements, schema validation, and hierarchical tree views"
...
All [hierarchical models](../../schema/hierarchy) will now display a tree view in the frontend to simplify navigation across the tree.
