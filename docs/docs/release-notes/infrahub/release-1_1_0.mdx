...
release_type: minor
description: "Computed attributes — a highly requested feature — plus many behind-the-scenes improvements."
---
<table>
  <tbody>
    <tr>
...
See [this table in the documentation](../../computed-attributes/overview.mdx#choosing-between-jinja2-and-python) for a concise comparison of the two types of computed attributes.
...
- [Computed Attributes Guide](../../computed-attributes/overview)
- [Computed Attributes Topic](../../computed-attributes/overview.mdx)
- [Transformation Topic](../../transformations/overview)
