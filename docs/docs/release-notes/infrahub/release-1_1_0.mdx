...
See [this table in the documentation](../../computed-attributes/index.mdx#choosing-between-jinja2-and-python) for a concise comparison of the two types of computed attributes.
...
- [Computed Attributes Guide](../../computed-attributes/)
- [Computed Attributes Topic](../../computed-attributes/index.mdx)
- [Transformation Topic](../../transformations/)
