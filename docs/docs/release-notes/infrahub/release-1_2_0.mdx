...
release_type: minor
description: "Highly anticipated new features alongside bug fixes and performance improvements."
---
<table>
  <tbody>
    <tr>
...
- [Object Template Topic](../../object-templates/overview)
- [Object Template Guide](../../object-templates/use)
...
If you have an existing schema that is using this namespace, you will first have to migrate these nodes to a different namespace. More information on how to perform schema updates can be found in our [documentation](../../schema/migration).
...
- [Activity Log Topic](../../deploy-manage/run-observe/activity-log)
...
Users of Neo4j-enterprise and infrahub-enterprise already had the capability to backup the Neo4j database following the process in our [documentation](../../deploy-manage/maintain-upgrade/database-backup/overview).

With Infrahub 1.2.0 there's a new requirement to also backup the PostgreSQL database that is used for Infrahub's internal task and event system. More information can be found in the [Database backup and restore guide](../../deploy-manage/maintain-upgrade/database-backup/backup-and-restore#create-a-full-backup).
