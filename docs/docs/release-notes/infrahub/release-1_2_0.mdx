...
- [Object Template Topic](../../topics/object-template.mdx)
- [Object Template Guide](../../guides/object-template.mdx)
...
If you have an existing schema that is using this namespace, you will first have to migrate these nodes to a different namespace. More information on how to perform schema updates can be found in our [documentation](../../topics/schema.mdx#schema-update-and-data-migrations).
...
- [Activity Log Topic](../../topics/activity-log.mdx)
...
- [Webhooks Topic](../../topics/webhooks.mdx)
- [Webhooks Guide](../../guides/webhooks.mdx)
