...
- [Object Template Topic](../../object-templates/)
...
Users of Neo4j-enterprise and infrahub-enterprise already had the capability to backup the Neo4j database following the process in our [documentation](../../deploy-manage/maintain-upgrade/database-backup/).
