...
release_type: patch
description: "Schema deletions are now rejected when a generic is still referenced by another node's inheritfrom, and partial schema writes are rolled back if loading the updated schema fails."
---
<table>
  <tbody>
    <tr>
