...
release_type: patch
description: "Fix hierarchical schema update logic to correctly update peer on parent relationship of new node (4838) Fix hierarchical schema update logic to correctly update peer on parent of new child node (4839)"
---
<table>
  <tbody>
    <tr>
    ...
    <tr>
      <th>Release Date</th>
      <td>November 8th, 2024</td>
    </tr>
    <tr>
      <th>Release Codename</th>
      <td>Stockholm, Patch #3</td>
    </tr>
    <tr>
      <th>Tag</th>
      <td>[infrahub-v1.0.3](https://github.com/opsmill/infrahub/releases/tag/infrahub-v1.0.3)</td>
    </tr>
  </tbody>
</table>
