---
title: Release 0.7
description: "Proposed Changes, Artifacts, and branch-aware schema models"
...
<table>
  <tbody>
    ...
    <tr>
      <th>Tag</th>
      <td>[0.7.0](https://github.com/opsmill/infrahub/releases/tag/0.7.0)</td>
    </tr>
  </tbody>
</table>
...
The repository [infrahub-demo-edge](https://github.com/opsmill/infrahub-demo-edge) has been updated to include some Artifact Definition.
