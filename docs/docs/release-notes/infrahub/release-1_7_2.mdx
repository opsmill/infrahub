...
release_type: patch
description: "Added 'parallel mode' plugin to the GraphQL web sandbox. GraphQL query parsing and validation is now leveraging a cache to improve performance and CPU consumption."
---
<table>
  <tbody>
    <tr>
