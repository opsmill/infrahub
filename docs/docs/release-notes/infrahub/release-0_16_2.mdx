...
release_type: patch
description: "Loading a schema with an invalid order by field raises a proper error. Updates internal logic to improve performance when generating a diff."
---
<table>
  <tbody>
    <tr>
