...
release_type: patch
description: "Make URL fields clickable in the details view (5005)"
---
<table>
  <tbody>
    <tr>
    ...
    <tr>
      ...
      <td>Stockholm, Patch #10</td>
    </tr>
    <tr>
      <th>Tag</th>
      <td>[infrahub-v1.0.10](https://github.com/opsmill/infrahub/releases/tag/infrahub-v1.0.10)</td>
    </tr>
  </tbody>
</table>
