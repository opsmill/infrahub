...
description: "Multiple Profile selection and relationship select fixes"
...
* Add option to fetch peers nodes in query_peers by @dgarros in [#3870](https://github.com/opsmill/infrahub/pull/3870)
