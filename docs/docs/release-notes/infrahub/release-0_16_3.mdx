...
release_type: patch
description: "Save a diff in smaller pieces instead of all at once to prevent out-of-memory error. Fixes exception handling section in the Python SDK batch guide."
---
<table>
  <tbody>
    <tr>
