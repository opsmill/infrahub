...
release_type: patch
description: "Added the ability to use alternative value types for all attribute types with computed attributes. Computed Attribute of kind Jinja will only be recalculated during a schema update if the template itself has been updated."
---
<table>
  <tbody>
    <tr>
