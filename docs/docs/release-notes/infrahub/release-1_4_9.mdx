...
release_type: patch
description: "Fix prefix/IP Address creation when passing in ipnamespace's HFID (7239) Fix bug in schema integrity checks of a proposed change that prevented resolved violations from being removed (7278)"
---
