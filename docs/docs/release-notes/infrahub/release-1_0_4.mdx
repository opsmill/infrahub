...
release_type: patch
description: "Profiles now have a Human-Friendly Identifier (HFID) defined based on their Profile name (4758) Workers out of sync after deleting node from schema (4836)"
---
<table>
  <tbody>
    <tr>
