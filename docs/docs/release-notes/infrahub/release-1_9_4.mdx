...
release_type: patch
description: "Adds a rebase_branch global permission; diff calculation now scales with the branch's changes instead of database size, and IP/MAC attribute values are normalized."
---
<table>
  <tbody>
    <tr>
