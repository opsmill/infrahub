...
release_type: patch
description: "Link a merging proposed change to its diff during the merge operation if it has not been linked yet (8769) Fixed an issue where webhook match statements (node kind filters) were lost during scheduled reconfiguration."
---
<table>
  <tbody>
    <tr>
