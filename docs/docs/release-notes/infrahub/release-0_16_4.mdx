...
release_type: patch
description: "Fixed an issue on the UI where a new relationship was being added to the main branch instead of the current branch."
---
<table>
  <tbody>
    <tr>
    ...
    <tr>
      <th>Release Date</th>
      <td>October 17th, 2024</td>
    </tr>
    <tr>
      <th>Release Codename</th>
      <td>Beta #5, Patch #4</td>
    </tr>
    <tr>
      <th>Tag</th>
      <td>[infrahub-v0.16.4](https://github.com/opsmill/infrahub/releases/tag/infrahub-v0.16.4)</td>
    </tr>
  </tbody>
</table>
