---
title: Release 1.4.0
description: "Generic list view redesign, IPAM improvements, and proposed change approvals"
...
Please refer to the documentation for a guide that explains how to setup a change approval workflow: [Change Approval Workflow Guide](../../change-approval/change-approval-workflow)
