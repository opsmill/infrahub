...
release_type: patch
description: "Fixed an error in the query to count the number of peers for a given cardinality-many relationship. Fixed the HFID format in the mutations IPAddressPoolGetResource and IPPrefixPoolGetResource."
---
<table>
  <tbody>
    <tr>
