...
release_type: patch
description: "Corrected data diff view within a proposed change or branch view so that changes to Profiles show up. Fixed hard failures on GraphQL queries that would exhaust Neo4j's server thread pool by implementing back off retry."
---
<table>
  <tbody>
    <tr>
