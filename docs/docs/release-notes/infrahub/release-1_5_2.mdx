...
release_type: patch
description: "Fix migration that backfills display labels and human-friendly IDs to account for schema that only exist on the branch being migrated. Prevent attempting diff update on a deleted branch."
---
