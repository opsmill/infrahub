...
release_type: patch
description: "Forbid changing the 'optional' property of an inherited attribute to not break GraphQL schema generation (4936) The permission to edit the default branch is now enforced properly when loading a schema (4958)"
---
<table>
  <tbody>
    <tr>
