...
release_type: patch
description: "Fixes CoreNumberPool upserts, migrations when an attribute stops being unique, and cardinality constraints declared on subtypes of a generic peer."
---
<table>
  <tbody>
    <tr>
