...
release_type: patch
description: "Added support for computed attributes on generics. Added new infrahub db selected-export command to run an anonymized export of selected object that includes no actual data."
---
<table>
  <tbody>
    <tr>
