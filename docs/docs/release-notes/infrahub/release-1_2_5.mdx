...
release_type: patch
description: "Added support for computed attributes on generics. Added a new database selected-export command to run an anonymized export of selected objects that includes no actual data."
---
<table>
  <tbody>
    <tr>
