...
release_type: patch
description: "Remove uniqueness constraint on generic templates to support upsert mutations (6478) Add a migration to clean up duplicated data from improper merges of branches containing node schemas with an updated kind or inheritance (6502)"
---
<table>
  <tbody>
    <tr>
