...
release_type: minor
description: "Built-in IPAM: IPv4/IPv6 prefixes and addresses with automatic prefix trees."
---
<table>
  <tbody>
    <tr>
...
More information about IPAM is available in the [Documentation](../../ipam/overview).
...
More information about Profiles is available in the [Documentation](../../profiles/overview).
...
Similar to the Transformations & artifacts, Generator will be automatically executed as part of the CI Pipeline if the data associated with a given Generator has changed.
...
More information about Generators is available in the [Documentation](../../generators/overview).
