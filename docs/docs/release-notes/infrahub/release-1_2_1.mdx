...
The issue has been fixed in 1.2.1 and the documentation has been updated to include more information regarding the upgrade procedure for Infrahub [Community](../../deploy-manage/maintain-upgrade/upgrade/) & [Enterprise](../../deploy-manage/maintain-upgrade/upgrade/enterprise)
...
[Upgrade Guide](../../deploy-manage/maintain-upgrade/upgrade/)
