...
release_type: patch
description: "Adds Neo4j cluster addresses via INFRAHUB_DB_ADDRESS; fixes Git repository re-pointing, cascade-delete validation, and missing webhook account IDs."
---
<table>
  <tbody>
    <tr>
