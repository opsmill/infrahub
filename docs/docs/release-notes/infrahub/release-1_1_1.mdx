...
release_type: patch
description: "Raise a better error when trying to resolve an invalid HFID for a relationship (5360) Fix an issue with session management that could lead to the crash of the GraphQL resolver"
---
<table>
  <tbody>
    <tr>
