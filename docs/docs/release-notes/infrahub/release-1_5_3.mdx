...
release_type: patch
description: "Fixed bug that prevented retrieving cardinality-one relationships on a branch that was already merged and included changes to the relationship."
---
