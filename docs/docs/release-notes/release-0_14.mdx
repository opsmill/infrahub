...
This initial implementation supports IP Prefix and IP Address, with future support for additional resources like VLAN, IDs, and interfaces.
...
The page for viewing detailed GraphQL queries has been redesigned for better usability and readability.
You can now directly load and execute queries in the GraphQL sandbox.
...
All branches now operate in isolated mode by default, similar to Git branches.
