...
For general information about Python Transformations, see the [Python Transformation guide](../learn/tutorials/transformations/build-a-python-transformation). For details about webhook events and payloads, see [Webhooks](./overview).
