...
For general information about Python Transformations, see the [Python Transformation guide](../guides/python-transform.mdx). For details about webhook events and payloads, see [Webhooks](./).
