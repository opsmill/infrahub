...
Walk through [Build a check](../learn/tutorials/build-a-check.mdx) in Academy to set up the GraphQL query, implement the check logic, configure `.infrahub.yml`, and validate the check against a proposed change end-to-end.
