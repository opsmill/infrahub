...
- Multi-vendor config generation — Arista, Juniper, Cisco, SONiC templates included
- Containerlab integration — deploy to a virtual lab and actually test your configs
- Service Catalog — simplified provisioning for when clicking buttons is preferable to YAML

<ReferenceLink title="Demo DC Fabric" url="$(base_url)bundle-dc" openInNewTab />
