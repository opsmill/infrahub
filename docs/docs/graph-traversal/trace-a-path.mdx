...
1. Open **Graph Traversal** from the main navigation.
2. Select the **Path** tab if it is not already active.
3. In **Source Object**, search for and select the starting object.
4. In **Destination Object**, search for and select the ending object.
...
On any object's detail page, select **Find paths** from the **Actions** menu. Graph Traversal
