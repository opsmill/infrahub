...
- [Understanding Git repositories in Infrahub](../git-integration/) - Repository integration concepts
...
- [Proposed changes](../proposed-changes/) - Understanding Infrahub's change management
