...
- [Managing resource pools](../resource-manager/) - Guide for creating and using pools
- [Resource Manager concepts](../resource-manager/) - Deep dive into allocation behaviour
