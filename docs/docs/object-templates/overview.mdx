...
<ReferenceLink title="Use object templates" url="/object-templates/use" />
...
<ReferenceLink title="Allocate resources from pools" url="/object-templates/allocate-resources-from-pools" />
