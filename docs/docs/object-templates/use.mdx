...
For more details, refer to the [Object Templates](./overview.mdx) topic.

## Enable template support within the schema

If you are already familiar with [Schema Development](../academy/tutorials/build-your-first-schema) in Infrahub, enabling template generation is straightforward.
...
You can now **load this schema into your Infrahub instance**. For more details, refer to the [Import Schema Guide](../schema/create-and-load).
