...
If you are already familiar with [Schema Development](../learn/tutorials/build-your-first-schema) in Infrahub, enabling template generation is straightforward.
