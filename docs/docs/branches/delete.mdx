...
Deleting a branch can also release branch-agnostic values that the branch was the last to read — including [resource pool](../resource-manager/overview.mdx) allocations, which return to the pool. See [Branch-agnostic data](./branch-agnostic-data.mdx).

## Related

- [Branches](./overview.mdx) — branch lifecycle and concepts
- [Merge a branch](./merge.mdx) — common predecessor to deletion
- [Branch-agnostic data](./branch-agnostic-data.mdx) — when deleting a branch releases a branch-agnostic value
