...
- [Generators](../generators/) that need consistent results
...
Resource Manager integrates seamlessly with [Generators](../generators/) to create fully automated provisioning workflows:
...
- [Generator Documentation](../generators/) - Automate configurations with allocated resources
- [GraphQL Documentation](../development-resources/graphql/) - Learn about Infrahub's GraphQL interface
