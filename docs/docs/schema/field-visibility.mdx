...
For controlling who can read or write a field, use [permissions and roles](../deploy-manage/user-management/permissions-roles/) instead.
...
- [Permissions and roles](../deploy-manage/user-management/permissions-roles/) — Controls who can read and write data
