...
For controlling who can read or write a field, use [permissions and roles](../topics/permissions-roles) instead.
...
- [Permissions and roles](../topics/permissions-roles) — Controls who can read and write data
