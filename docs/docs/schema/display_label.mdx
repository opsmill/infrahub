...
- [About schema](./overview) — Comprehensive guide to the schema system
- [Nodes & attributes](./nodes-and-attributes) — Human-friendly identifiers (HFID) as an alternative identification system
- [Menu customization](../menu/overview) — How node labels appear in the UI menu structure
