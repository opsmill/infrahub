...
- **[About schema](./overview)**: Extensions are part of the broader schema system and follow the same attribute and relationship definitions
- **[Branches](../branches/overview)**: Schema changes, including extensions, can be tested in branches before merging to main
