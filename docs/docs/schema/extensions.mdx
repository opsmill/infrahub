...
- **[About schema](./index)**: Extensions are part of the broader schema system and follow the same attribute and relationship definitions
- **[Branches](../topics/branching)**: Schema changes, including extensions, can be tested in branches before merging to main
