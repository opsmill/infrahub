...
Removing a branch-agnostic attribute or relationship this way releases its value without deleting any object, as long as no branch can still read the objects that hold it. See [Branch-agnostic data](../branches/branch-agnostic-data.mdx).
