...
Removing a branch-agnostic attribute or relationship this way releases its value without deleting any object, as long as no branch can still read the objects that hold it. See [Deleting a branch-agnostic attribute or relationship](./branch-awareness#deleting-a-branch-agnostic-attribute-or-relationship).
