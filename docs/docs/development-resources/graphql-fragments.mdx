...
- [Creating a Jinja Transformation](../learn/tutorials/transformations/build-a-jinja2-transformation) — using queries with Jinja2 templates
- [Creating a Python Transformation](../learn/tutorials/transformations/build-a-python-transformation) — using queries with Python code
