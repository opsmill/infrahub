...
When writing GraphQL queries for [transformations](../../transformations/), [generators](../../generators/), [artifacts](../../artifacts/), and [computed attributes](../../computed-attributes/index.mdx), it's critical to use a **single-target query pattern** to ensure proper tracking by the system.
...
- **Artifact definitions** - See [Artifacts](../../artifacts/)
