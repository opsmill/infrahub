...
[Groups](../../groups/index.mdx) are first-class objects in Infrahub that can be queried and manipulated through GraphQL. Groups provide powerful ways to organize and operate on collections of infrastructure objects.
...
See [organizing objects with groups](../../guides/groups.mdx) for creating and managing groups, and [understanding groups](../../groups/index.mdx) for architectural concepts.
