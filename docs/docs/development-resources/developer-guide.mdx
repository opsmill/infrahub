...
- [**Transformations** (Python and Jinja2)](../transformations/): Used to generate [artifacts](../artifacts/) and define [Computed Attributes](../computed-attributes/index.mdx).
- [**Generators**](../generators/): Automate complex tasks by generating outputs dynamically.
- [**Checks**](../checks/): Validate your infrastructure with custom rules.
