...
The `get` method allows you to retrieve a single object of a given kind from Infrahub, based on some [filters](#query-filters).
...
The `filters` method allows you to retrieve multiple objects of a given kind from Infrahub, based on some [filters](#query-filters).
