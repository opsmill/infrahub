...
- **Artifact differences**: Compare the [artifacts](../topics/artifact.mdx) generated to understand output changes.
...
Learn more about [Checks & Validation](../checks/index.mdx) and how to implement custom validation logic.

### Artifact generation

Infrahub will automatically run Transformations and generate artifacts as part of the proposed change workflow.

Learn more about [Transformations](../topics/transformation.mdx) and [Artifacts](../topics/artifact.mdx).

### Generator integration

Infrahub will automatically run Generators as part of the proposed change workflow.

Learn more about [Generators](../topics/generator.mdx).
...
- [Branches](../branches/index.mdx) — the underlying mechanism for change isolation
- [Immutable history](../topics/version-control.mdx) — the foundation of proposed changes
- [Schema](../topics/schema.mdx) — the data models reviewed in proposed changes
- [Artifacts](../topics/artifact.mdx) — outputs that are regenerated as part of proposed changes
- [Checks & Validation](../checks/index.mdx) — validation checks that gate merges
- [Transformations](../topics/transformation.mdx) — how Transformations are reviewed in proposed changes
- [Generators](../topics/generator.mdx) — Generators that may run in the proposed change pipeline
- [Permissions and roles](../topics/permissions-roles.mdx) — access controls for proposing, reviewing, and merging
