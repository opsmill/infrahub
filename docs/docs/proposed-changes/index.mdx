...
- **Artifact differences**: Compare the [artifacts](../artifacts/) generated to understand output changes.
...
Learn more about [Transformations](../transformations/) and [Artifacts](../artifacts/).

### Generator integration

Infrahub will automatically run Generators as part of the proposed change workflow.

Learn more about [Generators](../generators/).
...
- [Immutable history](../immutable-history/index.mdx) — the foundation of proposed changes
- [Schema](../schema/) — the data models reviewed in proposed changes
- [Artifacts](../artifacts/) — outputs that are regenerated as part of proposed changes
- [Checks & Validation](../checks/index.mdx) — validation checks that gate merges
- [Transformations](../transformations/) — how Transformations are reviewed in proposed changes
- [Generators](../generators/) — Generators that may run in the proposed change pipeline
- [Permissions and roles](../deploy-manage/user-management/permissions-roles/) — access controls for proposing, reviewing, and merging
