...
The submitted values collide with an existing node on a uniqueness constraint. The constraint members may be relationships as well as attributes.
...
```json
{
  ...
  "errors": [
    {
      "message": "The submitted values collide with an existing node on a uniqueness constraint. The constraint members may be relationships as well as attributes.",
      "extensions": {
