...
| [**default_filter**](#default_filter) | Attribute | Default filter used to search for a node in addition to its ID. (deprecated: please use human_friendly_id instead) | False |
| [**description**](#description) | Attribute | Short description of the model, will be visible in the frontend. | False |
| [**display_label**](#display_label) | Attribute | Attribute or Jinja2 template to use to generate the display label | False |
| [**display_labels**](#display_labels) | Attribute | List of attributes to use to generate the display label (deprecated) | False |
...
| [**order_by**](#order_by) | Attribute | List of entries used to order the results by default. Attributes, attributes of relationships, and created/updated_at object metadata are suppported. Any entry can be suffixed with '__asc' or '__desc' to set the direction (ascending by default).  | False |
| [**restricted_namespaces**](#restricted_namespaces) | Attribute | Nodes inheriting from this Generic schema must belong to one of the listed namespaces | False |
...
| **Name** | order_by |
| **Kind** | `List` |
| **Description** | List of entries used to order the results by default. Attributes, attributes of relationships, and created/updated_at object metadata are suppported. Any entry can be suffixed with '__asc' or '__desc' to set the direction (ascending by default).  |
| **Optional** | True |
| **Default Value** |  |
| **Constraints** |  |
