...
| `INFRAHUB_GIT_GLOBAL_CONFIG_FILE` | The location of the git config file. This will be set as the system `GIT_GLOBAL_CONFIG` environment variable if the environment variable is not initially set | string | /opt/infrahub/.gitconfig |
