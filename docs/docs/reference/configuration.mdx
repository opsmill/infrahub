...
| Name | Description | Type | Default |
|------|-------------|------|---------|
| `INFRAHUB_STORAGE_LOCAL_PATH` |  | string | /opt/infrahub/storage |
...
| `INFRAHUB_STORAGE_BUCKET_NAME` |  | string |  |
| `INFRAHUB_STORAGE_ENDPOINT_URL` |  | string |  |
| `INFRAHUB_STORAGE_USE_SSL` |  | boolean | True |
| `INFRAHUB_STORAGE_DEFAULT_ACL` |  | string | private |
| `INFRAHUB_STORAGE_QUERYSTRING_AUTH` |  | boolean | False |
| `INFRAHUB_STORAGE_CUSTOM_DOMAIN` |  | string |  |
