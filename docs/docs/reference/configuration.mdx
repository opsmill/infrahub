...
- Exporting in a shell, e.g.: `export INFRAHUB_API="http://localhost:8000"`
...
| INFRAHUB_CONFIG | Location of the configuration file for Infrahub | /config/infrahub.toml |  |  |
...
| INFRAHUB_DB_RETRY_LIMIT | Maximumm number of time a transient issue in a transaction should be retried. |  |  |  |
...
| INFRAHUB_INITIAL_ADMIN_TOKEN | An optional initial token for the admin account. | 06438eb2-8019-4776-878c-0941b1f1d1ec |  |  |
...
| INFRAHUB_SECURITY_SECRET_KEY | The secret key used to validate authentication tokens | 327f747f-efac-42be-9e73-999f08f86b92 |  |  |
