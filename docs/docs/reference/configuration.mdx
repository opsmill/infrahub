...
| `INFRAHUB_SELECTIVE_EXECUTION_AFTER_MERGE` | When enabled, only the generators and artifact definitions affected by a merge are re-executed; when disabled, every generator and artifact definition is re-executed. | boolean | False |
