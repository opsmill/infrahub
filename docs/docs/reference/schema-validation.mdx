...
Infrahub requires the user to define multiple YAML files. One or more files defining the [schema in Infrahub](../schema/) and the [external repository configuration file](../git-integration/).
