...
## Group Auto Create Cap Breach Event

**Type**: infrahub.group.auto_create.cap_breach
...
## Group Auto Create Rejected Claim Event

**Type**: infrahub.group.auto_create.rejected_claim
...
**Type**: infrahub.group.auto_create.created
