...
| Group Filter | `INFRAHUB_SECURITY_SSO_GENERATE_GROUPS_FILTER` | `security.sso_generate_groups_filter` | Regex pattern to filter which SSO groups are auto-generated. Only groups matching this pattern will be created. Supports capture groups to extract group names. | No |
