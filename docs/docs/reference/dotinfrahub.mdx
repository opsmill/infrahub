...
The file should be formatted as a Yaml file, have the filename `.infrahub.yml` and should be stored at the root of the [repository](../git-integration/overview).

:::info

See [this topic](../git-integration/infrahub-yml) for more details on the available repository configuration options
...
| watch | InfrahubWatchConfig | Extra files and directories this transform depends on, in addition to the ones Infrahub detects automatically. | False |
