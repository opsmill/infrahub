...
:::info
For conceptual explanations and usage guidance, see the [roles and permissions](../deploy-manage/user-management/permissions-roles/overview) topic.
:::
...
This role grants standard users the ability to view resources, make changes in non-default branches, and participate in the proposed change workflow (create proposed changes, comment, open threads, approve/close/reopen) on the default branch.
...
| `object:Core:ProposedChange:any:allow_all`       | Manage proposed changes on all branches                      |
| `object:Core:ChangeComment:any:allow_all`        | Manage proposed change comments on all branches              |
| `object:Core:ChangeThread:any:allow_all`         | Manage proposed change threads on all branches               |
| `object:Core:ThreadComment:any:allow_all`        | Manage replies inside proposed change threads on all branches |
