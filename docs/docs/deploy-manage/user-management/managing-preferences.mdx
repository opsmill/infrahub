...
- [DateTime attributes on object details drop the time from your chosen format](https://github.com/opsmill/infrahub/issues/10172); list views render it correctly.
- [Future-dated timestamps always render as relative time](https://github.com/opsmill/infrahub/issues/10173), so the date format preference does not apply to them yet.
- [The timezone field accepts any string](https://github.com/opsmill/infrahub/issues/10174); an invalid value is not rejected until it fails to render.
- [The date-format example preview ignores your timezone](https://github.com/opsmill/infrahub/issues/10175) and can show the wrong day.
