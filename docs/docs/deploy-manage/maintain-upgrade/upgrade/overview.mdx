...
- [Migrate from Community to Enterprise](./community-to-enterprise.mdx) — Convert an existing Community deployment to Enterprise in place, on Docker Compose or Helm
