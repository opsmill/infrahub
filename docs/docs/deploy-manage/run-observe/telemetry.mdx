...
1. Gathers anonymous usage data (schema counts, feature usage, database stats, and a point-in-time health status of backing services such as the database, message bus, cache, and task manager)
