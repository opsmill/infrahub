...
<details>
  ...
  helm install database-0 neo4j/neo4j --version 2026.4.0 --namespace infrahub --values neo4j-values.yaml
  helm install database-1 neo4j/neo4j --version 2026.4.0 --namespace infrahub --values neo4j-values.yaml
  helm install database-2 neo4j/neo4j --version 2026.4.0 --namespace infrahub --values neo4j-values.yaml
  ```
  ...
  ```bash
  helm install database-service neo4j/neo4j-headless-service --version 2026.4.0 --namespace infrahub --values service-values.yaml
  ```
