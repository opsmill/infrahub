...
Visit the [Next Steps](../getting-started/next-step) section for practical examples.
...
You can find all the details about both options directly on [our website](https://opsmill.com/infrahub-versions/).
