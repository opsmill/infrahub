...
- [Load Data](../getting-started/overview.mdx#data-input-and-sync): Populate Infrahub with your existing infrastructure data, either manually or by importing from other sources.
...
You can learn more about the OpsMill team and the company on our [About Us](https://www.opsmill.com/about-us) page on the OpsMill website.
