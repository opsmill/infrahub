...
- **Bare metal** — Infrahub Enterprise supports direct installation on physical or virtual servers without containerization, for environments where containers are not an option.
