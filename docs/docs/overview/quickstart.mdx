...
3. Load schema into your project:

:::info
To keep things clear you can put all schema files in a `schemas/` folder in your project and load them from there. You can copy the files you need from the `schema-library/` folder into your project's `schemas/` folder.
:::
