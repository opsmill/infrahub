...
If you cannot run `npx`, or want Claude Code's plugin marketplace for a global install, see [other installation methods](https://docs.infrahub.app/skills/installation-setup#installation).
