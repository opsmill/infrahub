...
To copy them in manually, place them in the same directory your assistant would use above (`.agents/skills/` for most assistants, `.claude/skills/` for Claude Code):

```bash
git clone https://github.com/opsmill/infrahub-skills.git
cp -r infrahub-skills/skills/* /path/to/your-project/.agents/skills/
