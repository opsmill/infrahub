...
<ReferenceLink title="Learn more about schema" url="../academy/tutorials/build-your-first-schema" />
...
<ReferenceLink title="Learn more about Transformations" url="../transformations/overview" />
...
<ReferenceLink title="Learn more about Generators" url="../generators/overview" />
...
<ReferenceLink title="Learn more about version control" url="../immutable-history/overview" />
...
Having a flexible schema opens up new possibilities not previously available. Infrahub allows a business workflow or service to be implemented in the [schema](../schema/overview) and instantiated by a Generator.
