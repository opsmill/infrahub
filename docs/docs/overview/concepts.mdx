...
<ReferenceLink title="Learn more about Transformations" url="../transformations/" />
...
<ReferenceLink title="Learn more about Generators" url="../generators/" />
...
<ReferenceLink title="Learn more about version control" url="../immutable-history/" />
...
Having a flexible schema opens up new possibilities not previously available. Infrahub allows a business workflow or service to be implemented in the [schema](../schema/) and instantiated by a Generator.
