...
The Quick Start used pre-built schemas from the Infrahub Marketplace. For a POC, model a slice of your actual infrastructure — the devices, services, or resources that matter most to your team.
...
<ReferenceLink title="Create a schema" url="../learn/tutorials/build-your-first-schema"/>
...
<ReferenceLink title="Connect a repository to Infrahub" url="../git-integration/connect-repository"/>
...
<ReferenceLink title="Generate artifacts" url="../artifacts/use"/>
...
<ReferenceLink title="Installation guide" url="../deploy-manage/install-configure/install/overview"/>
...
- [Build Generators](../learn/tutorials/generators/build-your-first-generator) to automate the creation of infrastructure objects from templates and business logic.
- [Set up events and webhooks](../events/overview) to trigger external systems when data changes.
