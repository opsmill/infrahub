...
- [Build Generators](../academy/tutorials/generators/build-your-first-generator) to automate the creation of infrastructure objects from templates and business logic.
