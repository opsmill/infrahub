...
<ReferenceLink title="High Availability Examples" url="../deploy-manage/install-configure/production-deployment/high-availability#deployment-examples" />

## Further reading

- [Infrahub Installation Guide](../deploy-manage/install-configure/install/overview.mdx) - Step-by-step installation instructions including high availability deployment examples
- [Hardware Requirements](../deploy-manage/install-configure/hardware-requirements.mdx) - System requirements for optimal performance
