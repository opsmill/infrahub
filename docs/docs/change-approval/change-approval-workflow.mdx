...
- Basic understanding of Infrahub's [roles and permissions system](../deploy-manage/user-management/permissions-roles/overview)
- Familiarity with [branching](../immutable-history/overview.mdx) and [proposed changes](../proposed-changes/overview) concepts
...
For a complete list of available global and object permissions, see the [Permissions documentation](../reference/permissions.mdx).
:::
...
- [Understanding proposed changes](../proposed-changes/overview)
- [Managing users and permissions](../deploy-manage/user-management/permissions-roles/overview)
- [Working with branches](../immutable-history/overview.mdx)
- [Configuring Git repositories](../git-integration/connect-repository)
