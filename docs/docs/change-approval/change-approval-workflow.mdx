...
- Basic understanding of Infrahub's [roles and permissions system](../deploy-manage/user-management/permissions-roles/)
- Familiarity with [branching](../immutable-history/index.mdx) and [proposed changes](../proposed-changes/) concepts
...
- [Understanding proposed changes](../proposed-changes/)
- [Managing users and permissions](../deploy-manage/user-management/permissions-roles/)
- [Working with branches](../immutable-history/index.mdx)
