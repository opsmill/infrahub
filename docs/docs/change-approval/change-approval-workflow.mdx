...
- Basic understanding of Infrahub's [roles and permissions system](../topics/permissions-roles.mdx)
- Familiarity with [branching](../topics/version-control.mdx) and [proposed changes](../topics/proposed-change.mdx) concepts
...
- [Understanding proposed changes](../topics/proposed-change.mdx)
- [Managing users and permissions](../topics/permissions-roles.mdx)
- [Working with branches](../topics/version-control.mdx)
- [Configuring Git repositories](../guides/repository.mdx)
