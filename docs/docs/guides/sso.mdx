...
If your identity provider sends groups with prefixes or paths (like `ldap/groups/network_automation`), you can use regex capture groups to extract just the relevant part as the group name:
