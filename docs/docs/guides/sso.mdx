...
:::info
By default, Infrahub requires you to create groups manually before SSO users can be assigned to them. However, you can enable automatic group creation — see [Enable automatic group creation](`#enable-automatic-group-creation-optional`) below.
:::
