...
If you want to know more about the differences between these two types, refer to the topic on [Repositories](../topics/repository.mdx).
...
- Access to a Git repository containing valid Infrahub resources (see [Initializing an Infrahub repository](../topics/developer-guide.mdx#initializing-an-infrahub-repository))
  - A [`.infrahub.yml`](../topics/repository.mdx#infrahub-yaml) configuration file in your Git repository
...
1. Check the repository status indicators:
   ...
   For detailed information about what each status means, refer to the [Repository Status documentation](../topics/repository.mdx#repository-statuses).
...
- [Repository concept explanation](../topics/repository.mdx)
- [Infrahub configuration file documentation](../topics/infrahub-yml.mdx)
