...
The repository should be visible under [Integrations / Git Repositories](http://localhost:8000/objects/CoreGenericRepository). If the repository you added has `Unknown` as Operational Status it means that Infrahub didn't managed to reach your repository. Verify the location and credentials.
