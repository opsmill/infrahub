...
2. If needed, i.e., your repository is private, create a Credential object to hold your username / password. We higly recommend to provide credentials for Repository to allow branch creation from Infrahub.
