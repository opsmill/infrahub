---
title: How to generate configuration artifacts from templates
---

import VideoPlayer from '../../src/components/VideoPlayer';

# How to generate configuration artifacts from templates
...
- **artifact_name**: Unique identifier (no spaces)
...
Copy the Storage ID from the artifact menu:
