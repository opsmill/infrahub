...
We will be using the `curl` command to upload the file. You might have to change the X-INFRAHUB-KEY header value to the API token of your user, if you are not using the default.
...
You might have to change the X-INFRAHUB-KEY header value to the API token of your user, if you are not using the default. The identifier in the URL should be the identifier that you gathered from the previous step.
