---
title: Quick Start
description: A step-by-step guide to set up a local Infrahub development environment, load schemas, and start building automation solutions.
---
...
Your project directory should contain files like `pyproject.toml`, and a `schemas/` folder.
:::
