...
For resilient, high-availability deployments, refer to the [high availability architecture](../topics/architecture#high-availability-deployment) documentation.
...
- [High availability architecture](../topics/architecture#scalability-and-high-availability) - Understand resilient deployment architectures
