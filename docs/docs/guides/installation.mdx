...
On Windows, install an Ubuntu Linux VM via [WSL2](https://learn.microsoft.com/en-us/windows/wsl/install) and follow the installation guide for Ubuntu.
...
Depending on your system configuration, you might have to give other users write permissions to the `/opt/` directory.
