...
- [https://infrahub.opsmill.io/1.0.7](https://infrahub.opsmill.io/1.3.3)
...
Please reach out if you need help and feel free to send a PR with installation instructions for your platform.
...
<TabItem value="GitHub Codespaces">
...
- **infrahub:** a deployment running with no [Schema](../tutorials/getting-started/schema) or data pre-installed
