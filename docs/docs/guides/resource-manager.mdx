...
This guide shows you how to create resource pools and allocate resources from them automatically. Resource Manager eliminate manual IP address and number assignment by providing dynamic allocation from predefined pools.
...
Resource Manager allocate resources across all branches to prevent conflicts.
