...
The goal of this guide is to show you how to create a resource pool, and how you can allocate resources using them. This includes IP address pools, IP prefix pools, and number pools (such as VLAN ID or ASN pools).
...
- [Using IP address pool](#using-ip-address-pool)
- [Using IP prefix pool](#using-ip-prefix-pool)
- [Using number pool](#using-number-pool)
- [Branch agnostic resource allocation](#branch-agnostic-resource-allocation)
