...
<Tabs>
  ...
  ![Creating prefix 10.100.0 via the Web Interface](../media/guides/resource_manager_rss_prefix_10_100_0.png)
  </TabItem>
...
<Tabs>
  <TabItem value="web" label="Via the Web Interface" default>
  ![Creating IP address pool via the Web Interface](../media/guides/resource_manager_pool_ip.png)
  </TabItem>
...
<Tabs>
  ...
  ![Device creation via the Web Interface - Before](../media/guides/resource_manager_pool_device_before.png)
  ![Device creation via the Web Interface - After](../media/guides/resource_manager_pool_device_after.png)
...
<Tabs>
  <TabItem value="web" label="Via the Web Interface" default>
  ![Creating prefix 10.100.1.0 via the Web Interface](../media/guides/resource_manager_rss_prefix_10_100_1.png)
  </TabItem>
...
<Tabs>
  <TabItem value="web" label="Via the Web Interface" default>
  ![Creating Prefix Pool via the Web Interface](../media/guides/resource_manager_pool_prefix.png)
  </TabItem>
...
<Tabs>
  <TabItem value="web" label="Via the Web Interface" default>
  ![Creating Number Pool](../media/guides/resource_manager_pool_vlan.png)
  </TabItem>
...
<Tabs>
  ...
  ![Allocating Number Pool - Before](../media/guides/resource_manager_pool_vlan_before.png)
  ![Allocating Number Pool - After](../media/guides/resource_manager_pool_vlan_after.png)
  </TabItem>
