---
title: Upgrade Infrahub Community
---
...
If the core schema is reported to have been modified during the upgrade process it's strongly recommended to rebase any open non default branches once the system is online again.
