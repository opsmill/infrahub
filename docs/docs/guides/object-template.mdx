...
![Template List](../media/template_list.png)
...
<Tabs>
  ...
  ![Template Choice](../media/template_or_from_scratch.png)
  ...
  ![Fields Pre-populated From Template](../media/form_with_template.png)
...
![Component List](../media/object_components_created_using_template.png)
