...
![Group Action creation form](/img/docs/events/grp_actions-form-creation.png)

4. View the created Group Action details

![Group Action details](/img/docs/events/grp_actions-details.png)
...
![Generator Action creation form](/img/docs/events/generator-action-form-creation.png)
...
![Node Trigger form creation](/img/docs/events/node-trigger-form-creation.png)
...
![Node Trigger matches form](/img/docs/events/node-trigger-matches-form-creation.png)
...
![Group Trigger form creation](/img/docs/events/group-trigger-form-creation.png)
