...
For conceptual information about artifacts and their architecture, see [Artifacts](./).

> Assumes a working Infrahub instance, an existing Transformation ([Jinja2](../guides/jinja2-transform.mdx) or [Python](../guides/python-transform.mdx)), permission to create and modify schemas, and a Git repository connected to Infrahub.
...
- [Artifacts](./) — concept and architecture
- [Composing artifact content](./content-composition) — assemble a composite artifact from other artifacts or file objects
- [Write a Python Transformation](../guides/python-transform.mdx) — for non-template logic
- [Transformations](../topics/transformation.mdx) — reshape graph data into another format
