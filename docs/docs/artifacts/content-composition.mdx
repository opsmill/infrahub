...
This guide shows you how to build a composite [artifact](./) whose [Transformation](../topics/transformation.mdx) pulls in content from other artifacts or [file objects](../schema/file-object). This enables modular configuration pipelines where each artifact generates one section of a configuration, and a composite artifact assembles the final result.
...
- Familiarity with [creating a Jinja2 Transformation](../guides/jinja2-transform.mdx) or [creating a Python Transformation](../guides/python-transform.mdx)
...
- [Write a Jinja2 Transformation](../guides/jinja2-transform.mdx)
- [Write a Python Transformation](../guides/python-transform.mdx)
- [Use artifacts](./use)
- [Object storage](../topics/object-storage.mdx)
