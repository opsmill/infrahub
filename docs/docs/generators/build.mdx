...
For a step-by-step walkthrough with a running example, see [Build your first generator](../learn/tutorials/generators/build-your-first-generator) in the Academy tutorials.
