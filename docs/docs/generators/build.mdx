...
Create a schema node for the object kind the Generator operates on. Each instance of this kind becomes a potential Generator target. See [Understanding Schemas](../schema/) for syntax.
...
- **Events and Actions** — configurable rules that trigger on data changes (see [Rules & Actions](../events/))
