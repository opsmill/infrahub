...
- **[Webhooks](../webhooks)** — events can fire HTTP callbacks to external systems.
- **[Log forwarding](../deploy-manage/run-observe/log-forwarding/)** — Enterprise deployments can stream events to external SIEM systems.
