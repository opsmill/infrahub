...
For conceptual background on schemas and design patterns, see [About schema](../../schema/overview).
...
- Explore [Nodes & attributes](../../schema/nodes-and-attributes) for advanced concepts
- Explore [Relationships](../../schema/relationships) for relationship kinds and direction
- Learn how to [create and load schema files](../../schema/create-and-load) from existing sources
- Set up [external repositories](../../git-integration/connect-repository) to manage schemas with Git
