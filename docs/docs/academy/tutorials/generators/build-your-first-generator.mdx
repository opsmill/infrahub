...
For conceptual background, see [Generators](../../../generators/overview). For a recipe-form how-to without the running example, see [Build a generator](../../../generators/build).
...
- Familiarity with Generators and how they work in Infrahub (see [Generators](../../../generators/overview))
