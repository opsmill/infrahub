...
For conceptual information about Profiles, including inheritance rules and priority systems, see [Profiles](../../topics/profiles.mdx).
...
Learn more about Profile priorities in the [Profile priority system](../../topics/profiles.mdx#profile-priority-system) section.
