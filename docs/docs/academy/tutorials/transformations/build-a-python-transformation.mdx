...
To learn more about single-target queries and why they are important, see the [GraphQL topic](../../../topics/graphql.mdx#single-target-query-pattern).
:::
...
- [Use artifacts](../../../guides/artifact) — cache Transformation output and tie it to a specific target object
- [GraphQL fragments](../../../guides/graphql-fragment) — share query fragments across Transformations
