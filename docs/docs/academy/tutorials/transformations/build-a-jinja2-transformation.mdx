...
More information on loading schema files into Infrahub can be found in the [schema import guide](../../../guides/import-schema.mdx#load-a-schema-file).
...
- [Use artifacts](../../../guides/artifact) — cache rendered output and tie it to a specific target object
