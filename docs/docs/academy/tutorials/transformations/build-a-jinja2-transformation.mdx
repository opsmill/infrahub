...
For conceptual background, see [Transformations](../../../transformations/). For a recipe-form how-to without the running example, see [Write a Jinja2 transformation](../../../transformations/jinja2).

Within Infrahub a [Transformation](../../../transformations/) is defined in an [external repository](../../../git-integration/connect-repository). However, during development and troubleshooting it is easiest to start from your local computer and run the render using [infrahubctl render]($(base_url)infrahubctl/infrahubctl-render).
