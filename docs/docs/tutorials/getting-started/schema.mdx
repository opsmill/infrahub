...
import dcimYaml from '!!raw-loader!../../../../models/base/dcim.infrahub.yml';
import ipamYaml from '!!raw-loader!../../../../models/base/ipam.infrahub.yml';
import locationYaml from '!!raw-loader!../../../../models/base/location.infrahub.yml';
import organizationYaml from '!!raw-loader!../../../../models/base/organization.infrahub.yml';
import routingYaml from '!!raw-loader!../../../../models/base/routing.infrahub.yml';
...
<details>
  ...
  <CodeBlock language="yaml" title="DCIM Base Schema">{dcimYaml}</CodeBlock>
  <CodeBlock language="yaml" title="IPAM Base Schema">{ipamYaml}</CodeBlock>
  <CodeBlock language="yaml" title="Location Base Schema">{locationYaml}</CodeBlock>
  <CodeBlock language="yaml" title="Organization Base Schema">{organizationYaml}</CodeBlock>
  <CodeBlock language="yaml" title="Routing Base Schema">{routingYaml}</CodeBlock>
</details>
...
<details>
  ...
  > invoke demo.load-infra-schema
  --- abbreviated ---
  schema 'models/base/dcim.infrahub.yml' loaded successfully
  schema 'models/base/ipam.infrahub.yml' loaded successfully
  schema 'models/base/location.infrahub.yml' loaded successfully
  schema 'models/base/organization.infrahub.yml' loaded successfully
  schema 'models/base/routing.infrahub.yml' loaded successfully
