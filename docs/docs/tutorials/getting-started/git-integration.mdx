...
Please refer to [Repository](../../git-integration/overview) to learn more about it.
...
[How to create a Personal Access Token in GitHub](../../git-integration/connect-repository#github-access-token)
...
Refer to [Adding a repository guide](../../git-integration/connect-repository).

After adding the `infrahub-demo-edge` repository you will be able to see several new [Transformations](../../transformations/overview) and related objects:
...
- 9 GraphQL [Queries](../../development-resources/graphql/overview) under [Objects / GraphQL Query](http://localhost:8000/objects/CoreGraphQLQuery/) (Menu > Object Management > GraphQL Query)
