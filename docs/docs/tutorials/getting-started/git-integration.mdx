...
Please refer to [Repository](../../topics/repository.mdx) to learn more about it.
...
[How to create a Personal Access Token in GitHub](../../guides/repository.mdx#github-access-token)
...
Refer to [Adding a repository guide](../../guides/repository.mdx).

After adding the `infrahub-demo-edge` repository you will be able to see several new [Transformations](../../topics/transformation.mdx) and related objects:
