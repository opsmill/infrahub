...
Please refer to [Repository](../../git-integration/) to learn more about it.
...
After adding the `infrahub-demo-edge` repository you will be able to see several new [Transformations](../../transformations/) and related objects:
...
- 9 GraphQL [Queries](../../development-resources/graphql/) under [Objects / GraphQL Query](http://localhost:8000/objects/CoreGraphQLQuery/) (Menu > Object Management > GraphQL Query)
