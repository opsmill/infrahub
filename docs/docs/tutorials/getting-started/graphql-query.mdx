...
<YouTube id="KrEY4P6Pgn4" />

This short demo shows how to use the GraphQL query interface to explore and read data from Infrahub. It walks through how to open the built-in GraphQL interface and run your first queries against real infrastructure data.

<YouTube id="ZXjL6leaaAc" />
