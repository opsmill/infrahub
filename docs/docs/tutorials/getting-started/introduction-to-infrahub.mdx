...
| **RelationalDB**  | The task manager uses the relational database to sore and manage workflow metadata.                        | ---                                                            |
...
Please follow the [Installation Guide](../../deploy-manage/install-configure/install/overview) to spin up Infrahub before continuing the tutorial.
