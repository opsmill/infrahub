...
The system that you want to use to run the demo environment has to meet the [hardware requirements](../../deploy-manage/install-configure/hardware-requirements).
...
Refer to the [Installation Documentation](../../deploy-manage/install-configure/install/overview).
...
More accounts will be loaded with the [demo data](../../development-resources/local-demo-environment#load-some-data).

Refer to [User management](../../deploy-manage/user-management/authentication) page for more information regarding the possible rights.
