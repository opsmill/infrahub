...
Please refer to [Data lineage and metadata](../../topics/metadata.mdx) to learn more about it.
...
Navigate to the detailed page of any device, by clicking on the `Device Management` section of the menu, next click on `Device` under the `Network Device` sub section.

The metadata of an attribute or relationship can be accessed through clicking on the information icon to the right of the value. This will open up the metadata panel.
...
![Metadata panel showing lineage information](../../media/tutorial_4_metadata.png)
...
![Editing metadata in Infrahub](../../media/tutorial_4_metadata_edit.png)
