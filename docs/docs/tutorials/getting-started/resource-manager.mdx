...
- [Resource Manager Guide](../../resource-manager/) - Learn to create and configure all types of resource pools
- [Resource Manager Concepts](../../resource-manager/) - Understand advanced features like weighted allocation and pool composition
- [Generators Concepts](../../generators/) - Combine Resource Manager with automated configuration generation
