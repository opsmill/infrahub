---
title: Understanding Resource Manager (Tutorial)
---

Learn how Infrahub's Resource Manager automates IP address allocation by exploring existing pools and creating your first automated device deployment. You'll discover how branch-agnostic allocation prevents conflicts when multiple teams work on infrastructure changes simultaneously.

By the end of this tutorial, you'll understand:

- How Resource Manager eliminates manual IP address tracking
...
Now let's see Resource Manager in action by creating a new device that automatically receives an IP address from the pool.
...
This step demonstrates the most powerful feature of Infrahub's Resource Manager: allocations are visible and reserved across all branches, even before merging.
...
- **Automated allocation**: Resource Manager eliminates manual IP address tracking by automatically assigning the next available resource
...
- [Resource Manager Guide](../../resource-manager/overview) - Learn to create and configure all types of resource pools
- [Resource Manager Concepts](../../resource-manager/overview) - Understand advanced features like weighted allocation and pool composition
- [Generators Concepts](../../generators/overview) - Combine Resource Manager with automated configuration generation
