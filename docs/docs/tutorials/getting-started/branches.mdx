...
![Branch creation dialog](../../media/tutorial_1_branch_creation.png)
...
For an in-depth understanding of Infrahub's approach to handling differences between branches and merging them, please consult the [proposed change topic](../../topics/proposed-change.mdx).
