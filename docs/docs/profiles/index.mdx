...
Profiles and [Object Templates](../object-templates/) are complementary features that solve different parts of the configuration management problem.
...
For the integration mechanics, see [Object Templates — Integration with Profiles](../object-templates/#integration-with-profiles).
...
- [Object templates](../object-templates/) — How Profiles integrate with templates for powerful configuration management
- [Schema](../schema/) — Deep dive into schema design and how Profiles are generated
- [Metadata](../objects/metadata) — Learn about metadata tracking and data lineage
- [Version control](../immutable-history/index.mdx) — How Profiles work with branches and version control
