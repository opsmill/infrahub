...
Profiles and [Object Templates](../topics/object-template.mdx) are complementary features that solve different parts of the configuration management problem.
...
For the integration mechanics, see [Object Templates — Integration with Profiles](../topics/object-template.mdx#integration-with-profiles).
...
New to Profiles? Walk through [Creating and assigning Profiles](../academy/tutorials/profiles.mdx) in Academy. It creates a Profile end-to-end using a working network interface example.
