...
Infrahub garantee the immutability of the default branch by default (`main`)
...
This behavior is required to garantee the immutability of the default branch.
...
It's recommended to use a Proposed Change to merge a branch to garantee that all changes are valid and compliants.
