...
The Schema Marketplace page (accessible from the main navigation) lets you browse the [Infrahub Marketplace](https://marketplace.infrahub.app) and install schemas or collections without leaving the web UI.
...
1. Open **Schema Marketplace** from the sidebar.
