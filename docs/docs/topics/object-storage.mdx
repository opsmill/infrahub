...
You can interact with object storage through the REST API and Python SDK. For practical steps, see the [object storage guide](../guides/object-storage) and the [object storage Python SDK guide](../python-sdk/guides/object-storage).
...
```yaml
    ...
    INFRAHUB_STORAGE_ENDPOINT_URL: "https://s3.eu-central-1.amazonaws.com"
    # ... other configuration ...
```
