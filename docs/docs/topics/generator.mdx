...
| `CoreGeneratorGroup`  | Tracks which objects were **created by** a Generator. Managed automatically by the SDK tracking feature. | No — Infrahub manages this automatically |
