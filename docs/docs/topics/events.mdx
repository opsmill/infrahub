...
* They enable event-driven automation, such as triggering [webhooks](./webhooks.mdx) and [event rules and actions](./event-actions.mdx).
* They can be forwarded to external SIEM systems via [log forwarding](./log-forwarding.mdx) (Enterprise Edition).
