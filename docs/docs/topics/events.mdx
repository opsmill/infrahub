...
You can find the exhaustive list of events in the [Infrahub events](../reference/infrahub-events) page.

These events serve multiple purposes:

* They feed the [activity log](./activity-log), providing a detailed, chronological timeline of system changes.
* They enable event-driven automation, such as triggering webhooks.
