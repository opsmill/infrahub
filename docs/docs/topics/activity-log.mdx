...
![Global Activity log page](../media/activity_log_global.png)
...
:::info Child Events
Events containing child events have an extra (blue) icon on the left of the branch column
:::
...
![Device detail page with Activity logs panel](../media/activity_log_device.png)
...
* **Event type**: Filter by categories such as `Node Created`, `Branch Deleted`. You can find more information in the [Infrahub Events](../reference/infrahub-events) topic.
...
![Activity logs filters - primary](../media/activity_log_global_filters_primary.png)
![Activity logs filters - children](../media/activity_log_global_filters_children.png)
...
* **Event type**: The type of the event, for example, `infrahub.node.updated`. You can find more information in the [Infrahub Events](../reference/infrahub-events) topic.
...
![Activity details page with children](../media/activity_log_global_details_children.png)
![Activity logs details popover](../media/activity_log_device_popover.png)
