...
- [Understanding groups](../topics/groups) - Organizational concepts for targeting operations
- [How to organize objects with groups](../guides/groups) - Creating and managing groups
