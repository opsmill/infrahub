...
- [#3020](https://github.com/opsmill/infrahub/issues/3020) Sorting IP prefix aand IP address does not follow a natural way of doing it
- [#3047](https://github.com/opsmill/infrahub/issues/3047) Renumbering an existing IP prefix or IP address won't relocate it in the IPAM relationship tree, which means it won't be showing in the proper location
- [2955](https://github.com/opsmill/infrahub/issues/2955) There are no ways to programmatically know the next IP prefix available in a namespace or an IP prefix
- [2954](https://github.com/opsmill/infrahub/issues/2954) There are no ways to programmatically know the next IP address available in a namespace or an IP prefix