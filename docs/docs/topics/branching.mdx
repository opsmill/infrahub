...
:::warning
Once deleted, a branch enters a terminal state. Creating a Proposed Change against it, rebasing it, and triggering validation on it are no longer possible.
:::
