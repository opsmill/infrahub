...
:::note
You can define in the schema branch behavior for a given node or attribute of a node.
:::
...
For more information on working with branches in Infrahub, refer to these related documents:

- [How to create a branch](../guides/creating-branches.mdx)
- [Working with Proposed Changes](../guides/proposed-changes.mdx)
- [Understanding the Git integration model](./git-integration.mdx)
- [Branch permissions and access control](../reference/branch-permissions.mdx)
