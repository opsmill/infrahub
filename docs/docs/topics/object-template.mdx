...
When enabling template generation on a given schema node, Infrahub automatically detects whether the object has any component kind of relationships. If it does, Infrahub will generate corresponding templates for those related objects as well.
