...
- [Introduction to GraphQL queries](../tutorials/getting-started/graphql-query) - Learn to query profiles
- [GraphQL mutations](../tutorials/getting-started/graphql-mutation) - Create and update profiles via GraphQL
- [Lineage information](../tutorials/getting-started/lineage-information) - Track data origins with profiles
