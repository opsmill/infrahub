...
A branch provide a safe environment to prepare and validate a change before integrating it into the main branch by opening a [Proposed Change](/topics/proposed-change).
