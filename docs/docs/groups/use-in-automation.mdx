...
When the group's membership changes, the next artifact generation run picks up the new members automatically. See [artifacts](../artifacts/) for the full specification.
...
See [Transformations](../transformations/) for Jinja2 and Python Transformation details.
...
See [Checks](../checks/) for check authoring.
...
See [Generator overview](../generators/) for full details, including the difference between Standard and Generator groups.
...
- [Artifacts](../artifacts/), [Transformations](../transformations/), [Checks](../checks/), [Generators](../generators/) for feature-specific details.
