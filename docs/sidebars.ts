          ...
          items: [
            {
              ...
              link: {
                ...
                description:
                  'Release notes for Infrahub, grouped by minor version. Pick a version line to see its releases and updates.',
              },
              items: [
                { type: 'doc', id: 'release-notes/infrahub/docs-restructure', label: 'Documentation restructure' },
                {
                  ...
                  label: '1.10.x',
                  collapsed: false,
                  description: 'Graph path traversal, topology explorer, and LDAP authentication',
                  link: {
                    type: 'generated-index',
                    slug: 'release-notes/infrahub/1-10',
                ...
                },
                {
                  ...
                  label: '1.9.x',
                  collapsed: true,
                  description: 'Interactive schema visualizer and syslog log forwarding',
                  link: {
                    type: 'generated-index',
                    slug: 'release-notes/infrahub/1-9',
                ...
                },
                {
                  ...
                  label: '1.8.x',
                  collapsed: true,
                  description: 'File objects, branch freeze-on-merge, and Kubernetes backup',
                  link: {
                    type: 'generated-index',
                    slug: 'release-notes/infrahub/1-8',
                ...
                },
                {
                  ...
                  label: '1.7.x',
                  collapsed: true,
                  description: 'Object-level metadata, Profile relationships, and backend upgrades',
                  link: {
                    type: 'generated-index',
                    slug: 'release-notes/infrahub/1-7',
                ...
                },
                {
                  ...
                  label: '1.6.x',
                  collapsed: true,
                  description: 'Dashboard landing page, Git integration, and Profiles in templates',
                  link: {
                    type: 'generated-index',
                    slug: 'release-notes/infrahub/1-6',
                ...
                },
                {
                  ...
                  label: '1.5.x',
                  collapsed: true,
                  description: 'Write-time HFIDs, backup & restore, and object type conversion',
                  link: {
                    type: 'generated-index',
                    slug: 'release-notes/infrahub/1-5',
                ...
                },
                {
                  ...
                  label: '1.4.x',
                  collapsed: true,
                  description: 'Generic list view redesign, IPAM, and proposed change approvals',
                  link: {
                    type: 'generated-index',
                    slug: 'release-notes/infrahub/1-4',
                ...
                },
                {
                  ...
                  label: '1.3.x',
                  collapsed: true,
                  description: 'Action system, Git data loading, and attribute parameters',
                  link: {
                    type: 'generated-index',
                    slug: 'release-notes/infrahub/1-3',
                ...
                },
                {
                  ...
                  label: '1.2.x',
                  collapsed: true,
                  description: 'Object templates, activity log, and enhanced webhooks',
                  link: {
                    type: 'generated-index',
                    slug: 'release-notes/infrahub/1-2',
                ...
                },
                {
                  ...
                  label: '1.1.x',
                  collapsed: true,
                  description: 'Computed attributes, task framework, and Git without shared storage',
                  link: {
                    type: 'generated-index',
                    slug: 'release-notes/infrahub/1-1',
                ...
                },
                {
                  ...
                  label: '1.0.x',
                  collapsed: true,
                  description: 'General availability: SSO, permissions framework, and UI redesign',
                  link: {
                    type: 'generated-index',
                    slug: 'release-notes/infrahub/1-0',
                ...
                },
                {
                  ...
                  label: '0.16.x',
                  collapsed: true,
                  description: 'Number resource pools, Git repository UX, and faster diffs',
                  link: {
                    type: 'generated-index',
                    slug: 'release-notes/infrahub/0-16',
                    title: '0.16.x releases',
                    description: 'Number resource pools, Git repository UX, and faster diffs',
                  },
                  items: [
                ...
                },
                {
                  ...
                  label: '0.15.x',
                  collapsed: true,
                  description: 'Profiles, schema validation, and hierarchical tree views',
                  link: {
                    type: 'generated-index',
                    slug: 'release-notes/infrahub/0-15',
                    title: '0.15.x releases',
                    description: 'Profiles, schema validation, and hierarchical tree views',
                  },
                  items: [
                ...
                {
                  type: 'category',
                  label: 'Early releases (0.6 – 0.14)',
                  collapsed: true,
                  description: 'Open beta and the earliest development releases',
                  link: {
                    type: 'generated-index',
                    slug: 'release-notes/infrahub/early',
                    title: 'Early releases (0.6 – 0.14)',
                    description: 'Open beta and the earliest development releases',
                  },
                  items: [
