...
For general information about Python Transformations, see the [Python Transformation guide](./python-transform.mdx). For details about webhook events and payloads, see [Webhooks](../webhooks/).
...
See [Webhooks](../webhooks/) for example event payloads.
