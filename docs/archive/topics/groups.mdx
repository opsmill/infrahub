...
Object templates can pre-populate these relationships for the instances they create — see [Object Templates → Integration with Groups](./object-template.mdx#integration-with-groups).
