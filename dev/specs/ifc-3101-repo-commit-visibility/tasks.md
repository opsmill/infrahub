...
| 3 | **Per-branch graph query.** `RepositoryBranchValuesQuery` and the tests pinning its inheritance. Block 2.5 | T021-T024; **T097 deferred and T101 lands after this pull request, not in it** | PR 2. T021/T022 may merge either side of checkpoint 2A; T023/T024 edit files PR 2 creates and cannot precede it |
...
**T097 and T101 are deliberately not part of this pull request.** The query this block adds has a
near-twin on the IFC-3104 side, and the two can only be consolidated once both have reached
`develop`. Nothing here waits for that: see T101 for why deferring is safe and what the eventual
merge has to reconcile, and T097 for the boundary agreement that reconciliation now stands in for.
...
- Block 2.5: T021 and T022 alongside blocks 2.2 to 2.4; T023 and T024 only after 2.3 and 2.4 (T097 deferred, T101 after both sides merge)
