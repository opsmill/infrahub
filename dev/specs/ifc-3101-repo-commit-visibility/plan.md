...
- `InfrahubMessageBus.rpc(timeout=...)` across the three adapters, `BrokerSettings.rpc_timeout`,
  ...
  error-catalogue artefacts, unit test with never-replying subclasses of both adapters.
