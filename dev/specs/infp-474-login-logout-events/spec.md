...
- **FR-002**: Successful login events MUST include: account_name, account_type, auth_method, session_id, groups, roles, identity_source, client_ip, user_agent and timestamp.
