...
├── contracts/
│   └── get-relationship-label.md   # UI contract for the rule
└── checklists/
...
├── get-relationship-label.ts        # NEW — the pure resolver rule
├── get-relationship-label.test.ts   # NEW — colocated Vitest unit test
