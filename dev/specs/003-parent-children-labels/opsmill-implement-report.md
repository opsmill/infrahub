...
| Low | `get-relationship-label.test.ts` | Empty-string peer `label` edge (truthiness fall-through) not covered. | Deferred — peer labels are always populated in practice. |
