...
While implementing this part, we do not require to write tests. The definition and inheritance of generics and nodes in the schema is alsready something very well tested. We do not need to write tests when adding more to the schema.
