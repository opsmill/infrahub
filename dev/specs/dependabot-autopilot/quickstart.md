...
| Q10 | Enable merges | Set `DEPENDABOT_AUTOPILOT_MERGE=on` once the shadow-mode exit criteria in [plan.md](plan.md#rollout) hold | Next `safe` PR with green CI is approved and squash-merged by the App |
