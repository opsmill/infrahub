...
- "No implementation details" is unchecked: the spec's Assumptions section names `psutil`, `/sys/fs/cgroup`, `pyproject.toml`, and the host identifier. Left in the spec body rather than moved, since planning has already progressed past it; flagged here rather than silently marked complete.
