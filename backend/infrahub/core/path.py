...
class GroupedDataPaths:
    def __init__(self) -> None:
        self._grouped_data_paths: Dict[Optional[str], List[DataPath]] = defaultdict(list)

    def add_data_path(self, data_path: DataPath, grouping_key: Optional[str] = None) -> None:
        self.add_data_paths([data_path], grouping_key)

    def add_data_paths(self, data_paths: List[DataPath], grouping_key: Optional[str]) -> None:
        self._grouped_data_paths[grouping_key].extend(data_paths)

    def get_data_paths(self, grouping_key: Optional[str] = None) -> List[DataPath]:
