...
core_models = {
    ...
    "generics": [
        ...
        },
        {
            ...
            "attributes": [
                {"name": "text", "kind": "Text", "unique": False, "optional": False},
    ...
    "nodes": [
        ...
        },
        {
            ...
            "relationships": [
                ...
                {
                    "name": "file_comments",
                    "peer": "CoreFileComment",
                    "optional": True,
                    "cardinality": "many",
                },
                {
                    "name": "object_comments",
                    "peer": "CoreObjectComment",
                    "optional": True,
                    "cardinality": "many",
                },
            ],
        },
        {
            "name": "FileComment",
            "namespace": "Core",
            "description": "A comment on proposed change related to a file",
            "label": "Comment - File",
            "default_filter": "text__value",
            "display_labels": ["text__value"],
            "branch": True,
            "inherit_from": ["CoreCommentBase"],
            "attributes": [
            ...
            "relationships": [
                ...
                {
                    "name": "children",
                    "peer": "CoreCommentBase",
                    "identifier": "corecomment__corecommentchild",
                    "cardinality": "many",
                    "optional": True,
                },
            ],
        },
        {
            "name": "ObjectComment",
            "namespace": "Core",
            "description": "A comment on proposed change related to an object",
            ...
            "inherit_from": ["CoreCommentBase"],
            "attributes": [
                {"name": "object", "kind": "Text", "optional": False},
                {"name": "resolved", "kind": "Boolean", "default_value": False},
            ],
            "relationships": [
                {
