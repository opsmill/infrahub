...
core_proposed_change = NodeSchema(
    ...
    relationships=[
        Rel(
            name="approvals",
            peer=InfrahubKind.PROPOSEDCHANGEAPPROVAL,
            optional=True,
            cardinality=Cardinality.MANY,
            kind=RelKind.ATTRIBUTE,
            branch=BranchSupportType.AGNOSTIC,
            identifier="approval__proposedchange_approvals",
            read_only=True,
        ),
        Rel(
            name="rejects",
            peer=InfrahubKind.PROPOSEDCHANGEREJECT,
            optional=True,
            cardinality=Cardinality.MANY,
            kind=RelKind.ATTRIBUTE,
            branch=BranchSupportType.AGNOSTIC,
            identifier="reject__proposedchange_rejects",
            read_only=True,
        ),
        Rel(
            name="reviewers",
