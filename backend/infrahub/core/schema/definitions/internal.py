...
base_node_schema = SchemaNode(
    ...
    attributes=[
        ...
        SchemaAttribute(
            ...
            description="Default filter used to search for a node in addition to its ID. Use an empty string to remove an existing value."
            " (deprecated: please use human_friendly_id instead)",
            optional=True,
            extra={"update": UpdateSupport.ALLOWED},
        ),
        SchemaAttribute(
