...
class GeneratedAttributeSchema(HashableModel):
    ...
    min_value: int | None = Field(
        default=None, description="Lowest possible value for the attribute.", json_schema_extra={"update": "allowed"}
    )
    max_value: int | None = Field(
        default=None, description="Highest possible value for the attribute.", json_schema_extra={"update": "allowed"}
    )
