...
class SchemaBranch:
    ...
    def add_relationships_to_template(self, node: NodeSchema | GenericSchema) -> None:
        ...
        for relationship in node.relationships:
            ...
            # For templates created from nodes with generate_template: true, all relationships
            # should be optional. This is essential for Parent relationships where the parent
            # object doesn't exist at template definition time. Making all relationships optional
            # is also appropriate for templates since they represent partial object definitions.
            # For autogenerated component templates, preserve the original optional value.
            is_optional = (
                relationship.optional
                if is_autogenerated_subtemplate
                else True  # All relationships on explicitly generated templates are optional
            )
            identifier = (
