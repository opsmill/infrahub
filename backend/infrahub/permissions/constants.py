...
GLOBAL_PERMISSION_DENIAL_MESSAGE = {
    ...
    GlobalPermissions.MANAGE_GLOBAL_PREFERENCES.value: "You are not allowed to manage global preferences",
...
GLOBAL_PERMISSION_DESCRIPTION = {
    ...
    GlobalPermissions.MANAGE_GLOBAL_PREFERENCES: "Allow a user to manage organisation-wide default preferences",
