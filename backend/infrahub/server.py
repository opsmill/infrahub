...
# work runs. The middleware resolves its controller and kill-switch from settings in its own
# initializer at stack-build time, mirroring the CORS middleware, so nothing is frozen at import.
