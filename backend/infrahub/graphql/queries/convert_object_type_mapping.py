...
async def fields_mapping_type_conversion_resolver(
    ...
    source_schema = core_registry.get_node_schema(name=source_kind, branch=info.context.branch)
    target_schema = core_registry.get_node_schema(name=target_kind, branch=info.context.branch)
