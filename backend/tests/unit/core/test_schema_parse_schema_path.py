...
class TestSchemaParseSchemaPath:
    def test_property_only_is_invalid(self, db: InfrahubDatabase, car_person_schema):
    ...
    def test_invalid_paths(self, db: InfrahubDatabase, car_person_schema, bad_path):
        car_schema = db.schema.get(name="TestCar")
    ...
    def test_invalid_attribute_of_relationship_path(self, db: InfrahubDatabase, car_person_schema):
        car_schema = db.schema.get(name="TestCar")
    ...
    def test_invalid_property_of_attribute_path(self, db: InfrahubDatabase, car_person_schema):
        car_schema = db.schema.get(name="TestCar")
    ...
    def test_attribute_only_is_valid(self, db: InfrahubDatabase, car_person_schema):
        car_schema = db.schema.get(name="TestCar")
    ...
    def test_relationship_only_is_valid(self, db: InfrahubDatabase, car_person_schema: SchemaBranch):
        car_schema = db.schema.get(name="TestCar")
        ...
        assert schema_path == SchemaAttributePath(
            ...
            related_schema=db.schema.get(name="TestPerson"),
        )

    def test_relationship_and_attribute_is_valid(self, db: InfrahubDatabase, car_person_schema: SchemaBranch):
        car_schema = db.schema.get(name="TestCar")

        schema_path = car_schema.parse_schema_path(path="owner__name", schema=car_person_schema)

        owner_schema = db.schema.get(name="TestPerson")
        assert schema_path == SchemaAttributePath(
            relationship_schema=car_schema.get_relationship("owner"),
