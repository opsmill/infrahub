...
from infrahub.core.migrations.graph.m049_backfill_vertex_metadata import Migration049
...
async def test_migration_049(db: InfrahubDatabase, default_branch: Branch, car_person_schema: SchemaBranch) -> None:
    """Test that migration 049 correctly backfills metadata properties.
