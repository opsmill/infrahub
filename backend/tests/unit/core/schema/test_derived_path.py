...
# The hierarchical parent link is a real relationship named "parent" carrying an identifier.
READER_PARENT_REL = _rel(name="parent", peer="TestParent", identifier="parent__child")
...
CASES = [
    ...
    Case(
        name="a_parent_relationship_path_reaches_the_parent_peer",
        reader=_node("Reader", relationships=(READER_PARENT_REL,)),
        path="parent__name__value",
        expected=ReachesPeer(backing_field="name", peer_kinds=("TestParent",), hops=(READER_PARENT_HOP,)),
    ),
    Case(
