...
async def test_query_failure_cardinality_one(
    db: InfrahubDatabase,
    default_branch: Branch,
    car_accord_main: Node,
    car_volt_main: Node,
...
async def test_query_success_cardinality_one(
    db: InfrahubDatabase,
    default_branch: Branch,
    car_accord_main: Node,
    car_camry_main: Node,
...
async def test_query_success_cardinality_many(
    db: InfrahubDatabase,
    default_branch: Branch,
    car_accord_main: Node,
    car_camry_main: Node,
...
async def test_validator_cardinality_failure(
    db: InfrahubDatabase,
    branch: Branch,
    default_branch: Branch,
    person_john_main,
