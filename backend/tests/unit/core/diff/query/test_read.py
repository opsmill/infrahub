...
class TestDiffReadQuery(TestInfrahub):
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                {},
                DiffSummaryCounters(num_added=3, num_updated=6, from_time=Timestamp(), to_time=Timestamp()),
                id="no-filters",
            ),
            pytest.param(
                {"kind": {"includes": ["TestThing"]}},
                DiffSummaryCounters(num_added=3, num_updated=2, from_time=Timestamp(), to_time=Timestamp()),
                id="kind-includes",
            ),
            pytest.param(
            ...
            pytest.param(
                ...
                DiffSummaryCounters(num_updated=6, from_time=Timestamp(), to_time=Timestamp()),
                id="status-includes",
            ),
            pytest.param(
            ...
            pytest.param(
                ...
                DiffSummaryCounters(num_updated=2, from_time=Timestamp(), to_time=Timestamp()),
