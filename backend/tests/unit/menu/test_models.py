...
def test_menu_item_dict(menu_fixture_01_data: list[MenuItemDefinition]) -> None:
...
def test_menu_item_diff_attributes(menu_fixture_01_data: list[MenuItemDefinition]) -> None:
    menu_item = MenuItemDict.from_definition(definition=menu_fixture_01_data[0])
...
def test_menu_dict_from_definitions(menu_fixture_01_data: list[MenuItemDefinition]) -> None:
...
def test_menu_dict_get_all_identifiers(menu_fixture_01_data: list[MenuItemDefinition]) -> None:
    menu = MenuDict.from_definition_list(menu_fixture_01_data)
...
def test_menu_dict_get_item_location(menu_fixture_01_data: list[MenuItemDefinition]) -> None:
    menu = MenuDict.from_definition_list(menu_fixture_01_data)
