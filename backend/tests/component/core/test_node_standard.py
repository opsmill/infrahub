...
async def test_node_standard_create(db: InfrahubDatabase, empty_database: None) -> None:
    obj1 = MyStdNode(
...
async def test_node_standard_delete(db: InfrahubDatabase, empty_database: None) -> None:
...
async def test_node_standard_get(db: InfrahubDatabase, empty_database: None) -> None:
    obj1 = MyStdNode(
        attr1_str="obj1", attr2_int="1", attr4_bool=True, attr5_dict={"key1": "value2", "key2": {"key21": "Value21"}}
    )
...
async def test_node_standard_update(db: InfrahubDatabase, empty_database: None) -> None:
...
async def test_node_standard_list(db: InfrahubDatabase, empty_database: None) -> None:
    obj1 = OtherStdNode(name="obj1")
    await obj1.save(db=db)
    obj2 = OtherStdNode(name="obj2")
    await obj2.save(db=db)
...
async def test_node_standard_pydantic(db: InfrahubDatabase, empty_database: None) -> None:
