...
def _snow_schema_with_format_identifier(extra_incident_attrs: list[AttributeSchema] | None = None) -> SchemaRoot:
    ...
    incident.get_attribute(
        name="identifier"
    ).computed_attribute.jinja2_template = "INC{{ '%09d' | format(number__value) }}"
