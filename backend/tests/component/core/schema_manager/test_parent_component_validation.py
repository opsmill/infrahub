...
async def test_one_parent_relationship_allowed(schema_parent_component: dict[str, Any]) -> None:
...
async def test_many_parent_relationships_not_allowed(schema_parent_component: dict[str, Any]) -> None:
...
async def test_parent_relationship_must_be_cardinality_one(schema_parent_component: dict[str, Any]) -> None:
    schema_dict = _get_schema_by_kind(schema_parent_component, "TestComponentNodeOne")
...
async def test_parent_relationship_must_be_mandatory(schema_parent_component: dict[str, Any]) -> None:
    schema_dict = _get_schema_by_kind(schema_parent_component, "TestComponentNodeOne")
...
async def test_only_one_parent_relationship_when_inheriting_from_generic(
    schema_parent_component: dict[str, Any],
) -> None:
...
async def test_hierarchy_cannot_contain_loop(schema_parent_component: dict[str, Any]) -> None:
    schema_dict = _get_schema_by_kind(schema_parent_component, "TestComponentGenericOne")
    schema_dict["relationships"].append(
        {
            "name": "bad_component",
...
async def test_hierarchy_cannot_contain_implied_loop(schema_parent_component: dict[str, Any]) -> None:
