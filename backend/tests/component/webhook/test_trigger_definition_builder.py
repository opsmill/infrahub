...
class TestWebhookToTrigger:
    async def test_standard_webhook(
        ...
        assert action.parameters == {
            ...
            "branch_name": {"__prefect_kind": "jinja", "template": "{{ event.resource['infrahub.branch.name'] }}"},
            "event_id": {"__prefect_kind": "jinja", "template": "{{ event.id }}"},
            "event_type": {"__prefect_kind": "jinja", "template": "{{ event.event }}"},
            "event_occured_at": {"__prefect_kind": "jinja", "template": "{{ event.occurred }}"},
            "event_payload": {
                "__prefect_kind": "json",
