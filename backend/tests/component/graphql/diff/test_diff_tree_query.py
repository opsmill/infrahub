...
async def test_diff_tree_one_relationship_change(
    ...
    after_change_datetime = Timestamp()
    accord_label = await branch_car.get_display_label()
    john_label = await person_john_main.get_display_label()
    jane_label = await person_jane_main.get_display_label()
    ...
    assert car_response == {
        ...
        "label": await car_accord_main.get_display_label(),
    ...
    assert john_response == {
        ...
        "label": await person_john_main.get_display_label(),
    ...
    assert jane_response == {
        ...
        "label": await person_jane_main.get_display_label(),
