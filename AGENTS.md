...
Regenerate with: `uv run invoke backend.generate` or `cd frontend/app && pnpm run codegen`

## Boundaries

### Always Do

- Run formatters before committing (`uv run invoke format`, `pnpm run biome:fix`)
