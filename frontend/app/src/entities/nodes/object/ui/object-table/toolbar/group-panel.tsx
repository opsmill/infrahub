  ...
  return (
    <h3
      className={classNames(
        "font-medium text-xs border-b h-10 shrink-0 flex items-center p-2 text-neutral-600",
        className
      )}
      {...props}
    />
...
export function GroupPanelFooter({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={classNames("shrink-0 p-1 text-center border-t", className)} {...props} />;
}
