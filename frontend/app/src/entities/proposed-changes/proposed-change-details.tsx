...
import { PcApproveButton } from "@/entities/proposed-changes/action-button/pc-approve-button";
import { PcCloseButton } from "@/entities/proposed-changes/action-button/pc-close-button";
import { PcMergeButton } from "@/entities/proposed-changes/action-button/pc-merge-button";
import { Conversations } from "@/entities/proposed-changes/conversations";
