...
// The key set mirrors the backend DateFormat enum in backend/infrahub/core/preferences/constants.py (there: key -> strftime).
...
export const DATE_FORMAT_PRESETS: Record<DateFormatKey, DateFormatPresetDef> = {
  ...
  ISO_8601: { label: "yyyy-MM-dd'T'HH:mm:ssXXX", pattern: "yyyy-MM-dd'T'HH:mm:ssXXX" },
