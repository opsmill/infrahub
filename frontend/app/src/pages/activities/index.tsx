  ...
  return (
    <Content.Card className="flex grow flex-col">
      ...
      {!hasActivities ? (
        ...
        <>
          <div className="grid grid-cols-8 gap-2 px-4 py-2 font-semibold text-gray-500 text-xs dark:text-gray-400">
            <span>Date</span>
...
function EmptyActivitiesView({ hasFilters }: { hasFilters: boolean }) {
  return (
    <div className="flex grow flex-col items-center justify-center p-8 text-gray-500 dark:text-gray-400">
