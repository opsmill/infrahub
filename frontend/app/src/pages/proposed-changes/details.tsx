...
import { ProposedChangesChecksTab } from "@/entities/proposed-changes/checks-tab";
import { ProposedChangeDetails } from "@/entities/proposed-changes/proposed-change-details";
