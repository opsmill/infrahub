...
const checkboxCardVariants = tv({
  base: [
    focusVisibleStyle,
    "group/checkbox-card relative flex cursor-pointer items-center gap-3 rounded-lg border border-border-strong bg-white px-3 py-2 text-sm text-foreground-muted transition-all",
