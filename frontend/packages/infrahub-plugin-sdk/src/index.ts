...
/**
 * Attribute schema definition (simplified for plugins)
 */
...
/**
 * Relationship schema definition (simplified for plugins)
 */
...
/**
 * Model schema definition (simplified for plugins)
 */
...
/**
 * Plugin definition for export from a plugin package
 */
...
/**
 * Helper to define multiple plugins from a single package
 */
export function definePlugins(definitions: PluginDefinition[]): PluginDefinition[] {
  return definitions;
}
