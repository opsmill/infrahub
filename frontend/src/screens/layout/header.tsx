          ...
          {auth?.accessToken && (
            <Menu as="div" className="relative ml-3">
              ...
              <Transition
                ...
                <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-custom-black ring-opacity-5 focus:outline-none">
